        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-ocean-surface rounded-lg p-6 border border-ocean-outline">
                ...
                <p className="text-slate-300 mb-4">
                  I'm always open to new opportunities and meaningful projects. Whether you're looking for a Laravel
            ...
            <div className="bg-ocean-surface rounded-lg p-6 border border-ocean-outline">
              ...
              <p className="text-slate-300 mb-4">
                I'm a passionate Laravel developer with a strong background in building scalable and efficient web
                applications. I specialize in PHP, Laravel, Vue.js, and modern web technologies.
              </p>
              <p className="text-slate-300 mb-4">
                Currently open to new opportunities and exciting collaborations—feel free to reach out if you’d like
                to connect or discuss a potential project.
              </p>
